 ...
 * @author admin
 */
public class cmodule extends javax.swing.JFrame {

    /**
     * Creates new form cmodule
     */
    public cmodule() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cmodule.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
